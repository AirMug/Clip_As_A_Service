/*
#[test_only]
module clip_as_a_service::clip_as_a_service_tests {
    // uncomment this line to import the module
    // use clip_as_a_service::clip_as_a_service;

    const ENotImplemented: u64 = 0;

    #[test]
    fun test_clip_as_a_service() {
        // pass
    }

    #[test, expected_failure(abort_code = ::clip_as_a_service::clip_as_a_service_tests::ENotImplemented)]
    fun test_clip_as_a_service_fail() {
        abort ENotImplemented
    }
}
*/

module clip_as_a_service::my_module {
    use std::debug;
